...
public class HerbExtractorBlockEntityRenderer implements BlockEntityRenderer<HerbExtractorBlockEntity> {
    public HerbExtractorBlockEntityRenderer(BlockEntityRendererProvider.Context context) {
