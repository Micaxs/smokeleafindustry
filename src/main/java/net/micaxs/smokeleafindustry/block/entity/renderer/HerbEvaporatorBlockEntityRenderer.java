...
public class HerbEvaporatorBlockEntityRenderer implements BlockEntityRenderer<HerbEvaporatorBlockEntity> {
    ...
    @Override
    public void render(HerbEvaporatorBlockEntity pBlockEntity, float pPartialTick, PoseStack pPoseStack, MultiBufferSource pBuffer, int pPackedLight, int pPackedOverlay) {
