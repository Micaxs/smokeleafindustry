...
public class HerbEvaporatorScreen extends AbstractContainerScreen<HerbEvaporatorMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(SmokeleafIndustryMod.MOD_ID, "textures/gui/herb_evaporator_gui.png");

    public HerbEvaporatorScreen(HerbEvaporatorMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
