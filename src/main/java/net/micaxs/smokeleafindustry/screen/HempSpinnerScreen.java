...
public class HempSpinnerScreen extends AbstractContainerScreen<HempSpinnerMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(SmokeleafIndustryMod.MOD_ID, "textures/gui/hemp_spinner_gui.png");

    public HempSpinnerScreen(HempSpinnerMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
