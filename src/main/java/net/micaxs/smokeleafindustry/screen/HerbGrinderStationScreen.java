...
public class HerbGrinderStationScreen extends AbstractContainerScreen<HerbGrinderStationMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(SmokeleafIndustryMod.MOD_ID, "textures/gui/herb_grinder_station_gui.png");

    public HerbGrinderStationScreen(HerbGrinderStationMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
