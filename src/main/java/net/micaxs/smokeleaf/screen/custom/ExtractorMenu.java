...
public class ExtractorMenu extends AbstractContainerMenu {
    ...
    private static BlockEntity validateBlockEntity(BlockEntity be) {
        if (!(be instanceof ExtractorBlockEntity extractor)) {
            throw new IllegalStateException("BlockEntity is not a ExtractorBlockEntity!");
        }
        return extractor;
    }

    public ExtractorMenu(int containerId, Inventory inv, BlockEntity blockEntity, ContainerData data) {
