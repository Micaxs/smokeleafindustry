...
public class GrinderMenu extends AbstractContainerMenu {
    ...
    private static BlockEntity validateBlockEntity(BlockEntity be) {
        if (!(be instanceof GrinderBlockEntity grinder)) {
            throw new IllegalStateException("BlockEntity is not a GrinderBlockEntity!");
        }
        return grinder;
    }

    public GrinderMenu(int containerId, Inventory inv, BlockEntity blockEntity, ContainerData data) {
