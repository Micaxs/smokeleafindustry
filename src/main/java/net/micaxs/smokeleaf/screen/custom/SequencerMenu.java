...
public class SequencerMenu extends AbstractContainerMenu {
    ...
    public SequencerMenu(int containerId, Inventory inv, FriendlyByteBuf extraData) {
    ...
    private static BlockEntity validateBlockEntity(BlockEntity be) {
        if (!(be instanceof SequencerBlockEntity sequencer)) {
            throw new IllegalStateException("BlockEntity is not a SequencerBlockEntity!");
        }
        return sequencer;
    }

    public SequencerMenu(int containerId, Inventory inv, BlockEntity blockEntity, ContainerData data) {
        super(ModMenuTypes.SEQUENCER_MENU.get(), containerId);
        this.blockEntity = ((SequencerBlockEntity) blockEntity);
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.SEQUENCER.get());
    }
